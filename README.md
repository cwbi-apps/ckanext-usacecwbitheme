...
- [Docker Compose setup for CKAN](#docker-compose-setup-for-ckan)
  ...
  - [8. ckanext-envvars](#9-ckanext-envvars)
  - [9. CKAN\_SITE\_URL](#10-ckan_site_url)
  - [10. Manage new users](#11-manage-new-users)
  - [11. Changing the base image](#12-changing-the-base-image)
...
Add these lines to the `ckan-dev` service in the docker-compose.yml file
...
1. Create a new user from the Docker host, for example to create a new user called 'admin'
   ...
   `docker compose exec ckan-dev ckan user add admin email=admin@localhost`
